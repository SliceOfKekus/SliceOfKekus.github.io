...
async function hoare_partition(l, r, delay = 50) {
    var blocks =
    ...
    while (true) {
        ...
        // If two pointers met.
        if (i >= j) {
            for (var k = 0; k < numberCount; k++) blocks[k].style.backgroundColor = "#6b5b95";
            return j;
        }
...
function QuickSort(l, r) {
    ...
    if (l < r) {
        ...
        var pivot_idx = hoare_partition(l, r);
        //Recursively calling quicksort for left partition
        QuickSort(l, pivot_idx);
